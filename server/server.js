...
// require('./utils/cron/dailyReportJob') // to send daily registration reports to organizers
require('./utils/cron/backupJob') // to backup events and registrations every 6 hours
